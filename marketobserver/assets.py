...
ASSETS: dict[str, Asset] = {
    ...
    "XAUUSD": Asset("XAUUSD", "الذهب الفوري", "Gold Spot", "metals", "GC=F", "USD", 2),
    "XAGUSD": Asset("XAGUSD", "الفضة الفورية", "Silver Spot", "metals", "SI=F", "USD", 3),
    "USO": Asset("USO", "النفط", "Oil ETF", "commodity", "USO", "USD", 2),
